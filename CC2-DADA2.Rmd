---
tıtle: "Ousmane_SOW_ADM_CC2"
output: github_document
---

Je fais l’analyse bioinformatique des données de séquençage 16S rRNA de l’article de Rauer et al. (2025), intitulé « De-biasing microbiome sequencing data: bacterial morphology-based correction of extraction bias and correlates of chimera formation », en utilisant le pipeline DADA2 et le package phyloseq sous R. Cette analyse comprend le contrôle qualité des lectures, l’inférence des variants de séquence exacts (ASV), l’assignation taxonomique, l’analyse de la diversité microbienne aux différents niveaux taxonomiques, du phylum jusqu’à l’espèce, ainsi que la visualisation de la diversité alpha à l’aide des indices de Shannon et de Simpson selon les groupes d’échantillons. La section suivante décrit en détail les différentes étapes du traitement bioinformatique et des analyses réalisées.
